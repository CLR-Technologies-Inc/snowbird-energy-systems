    ...
    <div className="m-12">
      <div className={`rounded-2xl p-6 bg-blue-50`}>
        ...
        <div className={`text-black-800`}>
          <p className="whitespace-pre-wrap">You have connected to the content site successfully but there are no pages. Add a page in Snowbird Systems and then refresh this page.</p>
        </div>
      </div>
    </div>
  );
