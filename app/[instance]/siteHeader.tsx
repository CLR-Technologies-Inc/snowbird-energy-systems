        ...
        <div className="mx-auto max-w-7xl flex flex-wrap items-center space-x-8 justify-between px-6 lg:px-8 py-4">
          <div className="flex items-center">
            ...
            <a aria-label="Home page" href="/">
              {largeLogo && largeLogo.url ? <Image className="h-8 w-auto hidden sm:block" src={largeLogo.url} alt={"Snowbird"} priority width={largeLogo.width} height={largeLogo.height} /> : <Image className="h-8 w-auto hidden sm:block" src="/snowbird-long-logo.png" alt="Snowbird" priority width={608} height={286} />}
              {smallLogo && smallLogo.url ? <Image className="h-8 w-auto sm:hidden" src={smallLogo.url} alt={"Snowbird"} priority width={smallLogo.width} height={smallLogo.height} /> : <Image className="h-8 w-auto sm:hidden" src="/snowbird-long-logo.png" alt="Snowbird" priority width={608} height={286} />}
            </a>
            <nav className="hidden lg:flex lg:space-x-8 lg:ml-12 xl:ml-16">
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-sky-50 px-3 py-1 text-xs font-semibold text-sky-700 hover:bg-sky-100 transition-colors"
              >
              ...
              <ul className="space-y-9">
                ...
                <li>
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 rounded-full bg-sky-50 px-3 py-1.5 text-sm font-semibold text-sky-700 hover:bg-sky-100 transition-colors"
                  >
